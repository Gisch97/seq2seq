...
EXPERIMENT_NAME="model_4_8_skip0_Optim_lr_avg_traspose"
MODEL_NAME="unet" 
...
BASE_OUTPUT_PATH="results/model_4_8/$EXPERIMENT_NAME"
...
n_4=(1)
num_conv=(2) 
learning_rates=(1e-5e-3 9e-3 1e-2 3e-2 5e-2 6e-2 7e-2 8e-2 9e-2 1e-1)
